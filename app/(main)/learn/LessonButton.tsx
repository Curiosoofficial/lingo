...
const LessonButton = ({
  ...
  const href = isCompleted ? `/learn/${id}` : "lesson";
        ...
        {current ? (
          <div className="size-[102px] relative">
            <div className="absolute -top-6 left-2.5 px-3 py-2.5 border-2 font-bold uppercase text-green-500 bg-white rounded-xl animate-bounce tracking-wide z-10">
              Start
              <div className="absolute -bottom-2 left-1/2 size-0 border-x-8 border-x-transparent border-t-8 transform -translate-x-1/2" />
            </div>
